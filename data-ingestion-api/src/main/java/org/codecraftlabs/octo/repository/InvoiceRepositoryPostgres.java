...
public class InvoiceRepositoryPostgres implements InvoiceRepository {
    ...
    public void insert(@Nonnull Invoice invoice) throws RepositoryException {
        try {
            ...
            jdbcTemplate.update(statement, invoice.getInvoiceId(), invoice.getName(), invoice.getCompanyName(), invoice.getBillToName(), invoice.getAmount(), invoice.getStatus(), invoice.getCreationDate(), invoice.getLastModificationDate());
